...
export default function Edit({ hero }: EditProps) {
    ...
    const [mediaPreview, setMediaPreview] = useState<string | null>(hero.media_url || null);
    const [posterPreview, setPosterPreview] = useState<string | null>(hero.poster_url || null);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        router.post(route('admin.website.heroes.update', hero.id), {
            ...data,
            _method: 'PUT',
        }, {
            forceFormData: true,
    ...
    return (
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-xs text-[#888888] mt-1">
                            Update headline copy, replace background image/video media, or adjust presentation order.
                        </p>
                    </div>
        ...
        >
            <Head title={`Edit Slide: ${hero.title} — EXFITS Admin`} />
            ...
            <form onSubmit={handleSubmit} className="max-w-4xl space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-3">
                            <label className="block text-xs font-bold text-white uppercase tracking-wider">
                                {data.media_type === 'video' ? 'Replace Background Video (MP4 / WebM)' : 'Replace Cover Image (JPG / PNG / WEBP)'}
                            </label>
                            ...
                            {mediaPreview ? (
                                ...
                                >
                                    ...
                                    <div className="text-xs font-bold text-white">Click to Select New {data.media_type === 'video' ? 'Video' : 'Image'}</div>
                ...
                <div className="flex items-center justify-end gap-3 pt-2">
                    ...
                    <Button type="submit" variant="primary" size="md" disabled={processing}>
                        ...
                        {processing ? 'Saving Changes...' : 'Update Hero Slide'}
                    </Button>
                </div>
            </form>
        </AuthenticatedLayout>
