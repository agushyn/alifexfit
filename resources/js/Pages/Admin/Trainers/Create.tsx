...
export default function TrainersCreate({ nextSortOrder = 0 }: CreateProps) {
    ...
    return (
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-xs text-[#888888] mt-1">
                            Register a certified gym instructor or personal coach for this branch and configure public photocard details.
                        </p>
                    </div>
        ...
        >
            <Head title="Add Trainer — EXFITS Gym" />
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center justify-end gap-3">
                        ...
                        <Button type="submit" variant="primary" size="md" disabled={processing}>
                            ...
                            {processing ? 'Saving Coach...' : 'Save Coach'}
                        </Button>
                    </div>
                </form>
            </div>
